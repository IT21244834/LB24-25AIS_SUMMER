...
const Frontoffice = () => {
  return (
    <FrontofficeContainer id="frontoffice">
      ...
      <FrontofficeWrapper>
        ...
        <FrontofficeCard backgroundColor="#F85A40">
          <FrontofficeH2>
            <FrontofficeLink to="/lb/igv_b2b_vd">iGV B2B</FrontofficeLink>
          </FrontofficeH2>
        </FrontofficeCard>
        <FrontofficeCard backgroundColor="#F85A40">
          <FrontofficeH2>
            <FrontofficeLink to="/lb/igv_cxp">iGV CXP</FrontofficeLink> {/* should be LB cxp  */}
          </FrontofficeH2>
        </FrontofficeCard>
      </FrontofficeWrapper>
      <br />
 ...
 <FrontofficeWrapper>
        <FrontofficeCard backgroundColor="#db4bca">
          <FrontofficeH2> 
            <FrontofficeLink to="/lb/ogx_b2b_ed">oGX B2B & ED</FrontofficeLink> {/* should be chnaged  */}
          </FrontofficeH2>
        </FrontofficeCard>
        <FrontofficeCard backgroundColor="#db4bca">
          <FrontofficeH2>
            <FrontofficeLink to="/lb/ogt">oGT</FrontofficeLink> {/* should be chnaged  */}
          </FrontofficeH2>
        </FrontofficeCard>
        <FrontofficeCard backgroundColor="#db4bca">
          <FrontofficeH2>
